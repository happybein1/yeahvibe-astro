...
See: [Earth Land — View per Individual](/applications/environment-energy/earth-land-view-per-individual) for the land use data behind these figures.
...
| Consideration | Plant-Based Advantage |
|---|---|
| Ethics | Avoids harm to sentient animals |
| Environment | Dramatically lower land and water use |
| Health | Can meet all nutritional needs with planning |
| Cost | Often cheaper per calorie than meat |
| Accessibility | Increasingly available worldwide |
